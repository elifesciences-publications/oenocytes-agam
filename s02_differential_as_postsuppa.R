...
suppaioef   = "data_as_suppa/Anogam_suppa.8nov18.ioe"   # IOE suppa file
exprtpmf    = "data_as_suppa/Anogam_salmon.8nov18_long.tpm"
...
genomefile  = "data_genome/Anogam_gDNA.fasta"
...
tx2genedict = "data_genome/Anogam_long.cds.csv"                         # transcript-to-gene mappings
annotmap    = paste(annottab,".blat",sep="")
outprefix   = basename(suppaioef)

# types of AS to analyse
